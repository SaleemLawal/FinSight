...
public class PlaidController {
    ...
    @Autowired
    private PlaidController(PlaidService plaidService, PlaidAccessTokenService plaidAccessTokenService, UserService userService) {
    ...
    public ResponseEntity<?> exchangePublicToken(@RequestBody Map<String, String> body, HttpServletRequest request) throws IOException {
        ...
        plaidAccessTokenService.createPlaidItem(userId, response.get("accessToken"), response.get("itemId"));
